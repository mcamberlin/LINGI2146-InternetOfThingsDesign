...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONFIG_DIR]/motes/proximity-sensor.c</source>
    ...
    <motetype>
      ...
      <source>[CONFIG_DIR]/motes/lamp.c</source>
    ...
    <motetype>
      ...
      <source>[CONFIG_DIR]/motes/temperature-sensor.c</source>
      <commands>make temperature-sensor.cooja TARGET=cooja</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
    ...
    <motetype>
      ...
      <source>[CONFIG_DIR]/motes/door.c</source>
      <commands>make door.cooja TARGET=cooja</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>37.387858124549474</x>
        <y>69.39844304039903</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>43.44111975752045</x>
        <y>78.85612976061218</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>26.51656305911675</x>
        <y>73.68267643441017</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>31.50917925174513</x>
        <y>60.015351378338146</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>47.677888978534526</x>
        <y>65.55997693815128</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>5.279786018736706 0.0 0.0 5.279786018736706 -2.3654152681111515 -229.60585225934406</viewport>
    </plugin_config>
    <width>400</width>
    <z>2</z>
    <height>400</height>
